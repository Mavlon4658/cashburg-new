...
export default function Auth () {
    return (<div className="h-screen w-screen flex items-center justify-center text-white gap-[25px]">
        <div className="bg-[#F6F6F6] w-[392px] rounded-[20px] h-[626px] min-h-[626px] border border-[#D3D9DD]">
            <div className="flex items-center justify-between p-[20px_25px_0] text-[#868A8A] text-[19px] font-semibold border-b border-[#D9D9D9]">
                <div className="flex items-center gap-[18px]">
                    <Link to={'/auth/register'} className="text-[#111216] pb-[13px] border-b-2 border-b-[#FF9500] mb-[-1px]">Регистрация</Link>
                    <Link to={'/auth/login'} className="pb-[13px] border-b-2 border-b-transparent mb-[-1px]">Вход</Link>
                </div>
                <button>
        ...
        <div className="bg-custom-gradient w-[392px] h-[626px] rounded-[20px]">
